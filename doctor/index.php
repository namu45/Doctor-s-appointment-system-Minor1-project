        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container doctor-header" style="border: none;width:95%;background-image:url('../img/ptt.jpg')" border="0" >
                    <tr>
                        <td >
                            <h3 id="a1">Welcome!</h3>
                            <h1 id="a1"><?php echo $username  ?>.</h1>
                            <p id="a1">Thanks for joinnig with us. We are always trying to get you a complete service<br>
