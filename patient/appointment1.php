...
<section id="book-section">
    <h1 id="book-head">Appointment Details </h1>
...
<tr>
  ...
  <td scope="row"><?php echo $data['specialties']; ?></td>
  <td scope="row"><?php echo $data['doctor']; ?></td>
  <td scope="row"><?php echo $data['date']; ?></td>
  <td scope="row"><?php echo $data['time']; ?></td>
  <td scope="row"><?php echo $data['booked_time']; ?></td>
  <td>
